if(!dojo._hasResource["uman.form.MultiSelect"]){
	dojo._hasResource["uman.form.MultiSelect"] = true;

	dojo.provide("uman.form.MultiSelect");

	dojo.require("dijit.form._FormWidget");

	dojo.declare("uman.form.MultiSelect",dijit.form._FormWidget,{
