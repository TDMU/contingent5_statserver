...
order by VCT.SORTORDER";
  ...
  from CONTENTTREE CT
  where CT.VISIBLE = 1
  and  CT.NODE_KEY in ('FPO_CAT_PAC','FPO_CAT_TU','FPO_CAT_SPECIALIZATION','FPO_CAT_STAGUVANNYA','FPO_CAT_TEACHER','FPO_CAT_SEMINARU','FPO_CAT_MASTERCLASS','FPO_CAT_PFOFSCHOOL')
